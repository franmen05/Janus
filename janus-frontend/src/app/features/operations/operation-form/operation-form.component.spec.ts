...
describe('OperationFormComponent', () => {
  ...
  beforeEach(async () => {
    ...
    operationServiceSpy.create.and.returnValue(of({
      id: 10, referenceNumber: 'OP-010', customerId: 1, customerName: 'Customer A',
  ...
  it('should mark form invalid when required fields empty', () => {
    ...
    component.form.patchValue({ customerId: '1', operationType: 'IMPORT', containerNumber: 'CONT-001', blNumber: 'BL-001', blAvailability: 'ORIGINAL', estimatedArrival: '2024-06-01' });
    expect(component.form.valid).toBeTrue();
  });

  it('should require containerNumber when transportMode is MARITIME', () => {
    fixture.detectChanges();
    component.form.patchValue({ customerId: '1', transportMode: TransportMode.MARITIME });
  ...
  it('should not require containerNumber when transportMode is AIR', () => {
    fixture.detectChanges();
    component.form.patchValue({ customerId: '1', transportMode: TransportMode.AIR });
  ...
  it('should call create on submit for new operations', () => {
    ...
    component.form.patchValue({
      customerId: '1', operationType: 'IMPORT', transportMode: TransportMode.MARITIME,
