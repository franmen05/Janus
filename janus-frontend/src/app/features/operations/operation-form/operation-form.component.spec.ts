...
describe('OperationFormComponent', () => {
  ...
  it('should initialize form with default values for new operation', () => {
    ...
    expect(component.form.get('blOriginalAvailable')!.value).toBe('');
  ...
  it('should mark form invalid when required fields empty', () => {
    ...
    component.form.patchValue({ clientId: '1', containerNumber: 'CONT-001', blNumber: 'BL-001', blOriginalAvailable: 'true' });
  ...
  it('should call create on submit for new operations', () => {
    ...
    component.form.patchValue({
      ...
      operationCategory: OperationCategory.CATEGORY_1, containerNumber: 'CONT-001', blNumber: 'BL-001', blOriginalAvailable: 'true', notes: ''
    });
    component.onSubmit();
