...
class OperationResourceTest {
    ...
    void testCustomerCannotCreateOperation() {
        given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "arrivalPortId": 1}
                        """)
    ...
    void testAccountingCannotCreateOperation() {
        given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL"}
                        """)
                .when().post("/api/operations")
                .then()
                .statusCode(403);
    ...
    void testCreateOperation() {
        createdOperationId = given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "notes": "Test operation", "arrivalPortId": 1}
                        """)
                .when().post("/api/operations")
                .then()
                .statusCode(201)
    ...
    void testUpdateOperation() {
        given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_3", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "notes": "Updated notes", "arrivalPortId": 1}
                        """)
    ...
    void testAgentCanCreateOperation() {
        given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 2, "operationType": "EXPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_2", "blNumber": "BL-TEST-002", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "arrivalPortId": 2}
                        """)
                .when().post("/api/operations")
                .then()
                .statusCode(201)
    ...
    void testClosedSetsClosedAt() {
        ...
        var opId = given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "incoterm": "FOB", "arrivalPortId": 1}
                        """)
                .when().post("/api/operations")
                .then().statusCode(201)
                .extract().jsonPath().getLong("id");
    ...
    void testUpdateClosedOperationForbidden() {
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-UPDATED", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "notes": "Should not work", "arrivalPortId": 1}
                        """)
    ...
    void testDeleteDraftOperation() {
        var draftId = given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "MARITIME", "operationCategory": "CATEGORY_1", "containerNumber": "CONT-001", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "arrivalPortId": 1}
                        """)
                .when().post("/api/operations")
                .then()
                .statusCode(201)
    ...
    private static Long advanceToInTransit() {
        var opId = given()
                ...
                .contentType(ContentType.JSON)
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-RR-COMP", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "incoterm": "FOB", "arrivalPortId": 1}
                        """)
                .when().post("/api/operations")
                .then().statusCode(201)
                .extract().jsonPath().getLong("id");
