...
class CommentResourceTest {
    ...
    void testSetup() {
        operationId = given()
                ...
                .body("""
                        {"clientId": 1, "transportMode": "MARITIME", "operationCategory": "CATEGORY_1", "containerNumber": "CONT-001", "blNumber": "BL-TEST-001", "blOriginalAvailable": true, "notes": "Comment test op"}
                        """)
