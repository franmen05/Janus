...
class ComplianceValidationTest {
    ...
    void testSetupOperation() {
        operationId = given()
                ...
                .body("""
                        {"accountId": 1, "operationType": "IMPORT", "transportMode": "AIR", "operationCategory": "CATEGORY_1", "blNumber": "BL-TEST-001", "estimatedArrival": "2025-12-01T10:00:00", "blAvailability": "ORIGINAL", "notes": "Compliance test", "arrivalPortId": 1}
                        """)
